...
let personNames = persons.map(personObj => personObj.name); // Complete here

let personsYoungerThan28YearsOld = persons.filter(personObj => personObj.age < 28)// Complete here
